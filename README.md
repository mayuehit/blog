...
2. package-lock.json的作用，当node_modules被删除时，不需要重新解析package.json了，减少时间.
3. package.json中type module的作用
4. [react学习文档](https://zh-hans.reactjs.org/docs/getting-started.html)
